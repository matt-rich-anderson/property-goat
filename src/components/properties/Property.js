...
export const Property = () => {
    ...
    return(<>
        <section key={property.id} className="property__section">
            <img  className="property__pic" src={property.imgUrl} alt="Property Image"/>
            ...
            <div className="property__stats">
                <p className="property__stats__det">Square Feet: {property.sqrFoot}</p>
                <p className="property__stats__det">Bedroom: {property.bedroom}</p>
                <p className="property__stats__det">Bath: {property.bath}</p>
                <p className="property__stats__det">Pets Allowed: {property.petsAllowed ? "Yes" : "No"}</p>
            </div>
